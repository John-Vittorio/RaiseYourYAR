...
export default function Navigation() {
  ...
  useEffect(() => {
    ...
    } else if (location.pathname.startsWith('/faculty') || location.pathname.startsWith('/admin/faculty')) {
      ...
      <div className="nav-content">
        <div>
          ...
          <ul>
            ...
            {/* Faculty YAR Directory - Admin only */}
            {currentUser.role === 'admin' && (
              <li
                onClick={() => handleNavClick('faculty', '/admin/faculty')}
